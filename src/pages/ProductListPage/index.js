      ...
      <div className="flex flex-wrap items-center md:justify-between sm:justify-center mb-5">
        ...
        <div className="flex justify-end w-2/4">
          ...
          <div
            ...
            className="inline-flex cursor-pointer items-center px-3 py-2 mr-6 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Add new product
          </div>
        </div>
